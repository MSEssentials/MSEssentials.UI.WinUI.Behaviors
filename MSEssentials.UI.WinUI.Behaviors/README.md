...
MSEssentials is package of useful classes, helpers, extensions and UI controls, I use in my C# projects. UI.WinUI.Behaviors subpackage contains XAML action triggers for WinUI applications.
